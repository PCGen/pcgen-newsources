							...
							<fo:table-body>
								...
								<fo:table-row>
									...
									<fo:table-cell number-rows-spanned="2">
										...
										<xsl:apply-templates select="eclipse_channeling"/>
...
====================================
====================================-->
	<xsl:template name="eclipsechanneling.intensity">
		<xsl:param name="die"/>
		...
		<fo:table-row>
			<xsl:call-template name="attrib"><xsl:with-param name="attribute" select="concat('eclipsechanneling.', $shade)"/></xsl:call-template>
			<fo:table-cell>
...
====================================
====================================-->
	<xsl:template name="eclipsechanneling.info">
		<xsl:param name="title"/>
		<xsl:param name="info"/>

		<fo:table-row>
			<fo:table-cell padding-top="1pt" text-align="end">
				<xsl:call-template name="attrib"><xsl:with-param name="attribute" select="'eclipsechanneling.title'"/></xsl:call-template>
				<fo:block font-size="8pt">
					<xsl:value-of select="$title"/>
				</fo:block>
			</fo:table-cell>
			<fo:table-cell padding-top="1pt">
				<xsl:call-template name="attrib"><xsl:with-param name="attribute" select="'eclipsechanneling'"/></xsl:call-template>
				<fo:block font-size="8pt">
...
====================================
====================================-->
	<xsl:template match="eclipsechanneling">
		...
		<fo:table table-layout="fixed" space-before="1mm" keep-together="always"  border-collapse="collapse" padding="0.5pt">
			<xsl:call-template name="attrib"><xsl:with-param name="attribute" select="'eclipsechanneling'"/></xsl:call-template>
			<xsl:call-template name="attrib"><xsl:with-param name="attribute" select="'eclipsechanneling.border'"/></xsl:call-template>
			<fo:table-column>
				...
				<fo:table-row>
					...
					<fo:table-cell>
						<fo:table table-layout="fixed" border-collapse="collapse" padding="0.5pt">
							...
							<fo:table-body>
								<xsl:call-template name="eclipsechanneling.info">
					...
					<fo:table-cell>
						...
						<fo:table table-layout="fixed"  border-collapse="collapse" padding="0.5pt">
							...
							<fo:table-body>
								...
								<xsl:call-template name="eclipsechanneling.intensity">
				...
				<fo:table-row>
					<fo:table-cell number-columns-spanned="2">
						<fo:table border-collapse="collapse" padding="0.5pt" table-layout="fixed">
							...
							<fo:table-body>
								<xsl:call-template name="eclipsechanneling.per.day">
...
====================================-->
	...
	<xsl:template name="eclipsechanneling.per.day">
		<xsl:param name="title" />
		<xsl:param name="value"/>
		<fo:table-row>
